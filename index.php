...
add_to_log($course->id, 'finalgrade', 'view all', 'index.php?id='.$course->id, '');

$coursecontext = get_context_instance(CONTEXT_COURSE, $course->id);

$PAGE->set_url('/mod/finalgrade/index.php', array('id' => $id));
...
foreach ($finalgrades as $finalgrade) {
    ...
    if ($course->format == 'weeks' or $course->format == 'topics') {
        $table->data[] = array($finalgrade->section, $link);
    } else {
